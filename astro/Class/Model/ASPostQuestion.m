...
- (id)init{
    if(self = [super init]){
        ...
        ct.FirstBirth = (NSDate<NSDate> *)[NSDate initWithYear:1990 month:1 day:1 hour:12 minute:0 second:0];
        ...
        ct.SecondBirth = (NSDate<NSDate> *)[NSDate initWithYear:1990 month:1 day:1 hour:12 minute:0 second:0];
